...
export async function createHousecallProMcpServer(): Promise<McpServer> {
  ...
  server.registerTool(
    ...
    async (input) => {
      const { estimateNumber, customerId, assignedEmployeeIds, addressId, leadSource, address, options, schedule, estimateFields, custom, ...rest } = input;
